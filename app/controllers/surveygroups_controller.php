<?php
/* SVN FILE: $Id: surveygroups_controller.php,v 1.15 2006/11/01 20:20:34 davychiu Exp $ */
...
//print_r($data);
    ...
    if (isset($this->params['form']) && $this->params['form']['select'] == 'user' && !empty($this->params['form']['livesearch2']))
