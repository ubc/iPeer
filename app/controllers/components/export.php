...
class ExportComponent extends CakeObject
{
    ...
    function createCSV($params, $courseId=null)
    {
        ...
        //get instructor name, NOTE: getInstructors function is called on User instead of UserCourse, the function in UserCourse is deprecated
        $header['instructors'] = empty($params['form']['include_instructor']) ? '':$this->User->getInstructors('all', array('conditions' => array('Course.id' => $courseId)));
    ...
    /**
     * createHeader create the header part of the csv file.
     *
     * @param mixed $params
     *
     * @access public
     ...
     * createBody
     *
     * @param mixed $groupEvents     group events
     * @param mixed $params          params
     * @param mixed $eventTemplateId event template id
     * @param mixed $eventTypeId     event type id
     *
     * @access public
     * @return void
     */
