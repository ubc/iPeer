...
$paging['style'] = 'ajax';
$paging['link'] = '/evaluations/search/?show='.$this->controller->show.'&sort='.$this->controller->sortBy.'&direction='.$this->controller->direction.'&page=';
...
$params = array('controller'=>'evaluations', 'data'=>$data, 'paging'=>$paging);
