  ...
  <tr>
    <td>
        <table width="95%" border="0" align="center" cellpadding="4" cellspacing="2">
          ...
          <tr class="tablecell2">
            <td width="19%">Prompt: <font color="red">*</font></td>
            <td width="48%"><?php echo $html->input('Question/prompt', array('size'=>'50','class'=>'input', 'style'=>'width:85%;')) ?></td>
            <td width="33%">E.g. What grade do you expect to earn in this class?</td>
          </tr>
          <tr class="tablecell2">
            <td>Master Question?</td>
            <td>
			<select name="master" style="width:85%;">
		  	<option value="yes" <?php if($params['data']['Question']['master']=='yes') echo "selected";?>>Yes</option>
			<option value="no" <?php if($params['data']['Question']['master']=='no') echo "selected";?>>No</option>
          ...
          <tr class="tablecell2">
            ...
            <td>
			<input type="radio" name="type" id="type" value="M" <?php if($params['data']['Question']['type']=='M') echo "checked";?>>Multiple Choice (Single Answer)</input><br>
        	<input type="radio" name="type" id="type" value="C" <?php if($params['data']['Question']['type']=='C') echo "checked";?>>Choose Any Of... (Multiple Answers)</input><br>
			<input type="radio" name="type" id="type" value="S" <?php if($params['data']['Question']['type']=='S') echo "checked";?>>Single Line Text Input</input><br>
			<input type="radio" name="type" id="type" value="L" <?php if($params['data']['Question']['type']=='L') echo "checked";?>>Long Answer Text Input</input><br>
			</td>
            <td>&nbsp;</td>
          </tr>
          <tr class="tablecell2">
