  ...
  <tr class="footer"">
    ...
    <td height="100%" width="250" valign="top">
      <table border="0" cellpadding="0" cellspacing="0" bordercolor="e2e2e2" class="subTable" width="250">
        <tr>
          <td height="21" background="../img/layout/header_back.gif"><div align="center" class="smallHeader">Instructions</div></td>
        </tr>
          
      </table>
      <br />
      Your password can be reset by submitting your student number and your iPeer email address here. Your new password will be sent to your iPeer email address.
    </td>
	</tr>
</table>
</form>
