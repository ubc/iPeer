<div class="login">
  <h2 class="title"><?php echo __('iPeer Login', true) ?></h2>
  <h3 class="subtitle">
    ...
    <span><?php echo __('Enter your information', true) ?></span>
  </h3>
  <p class="text-base">Please log in using your <strong>UBC CWL</strong> (Campus-Wide Login). If you need help with logging in, please contact <a href="mailto:ipeer.support@ubc.ca">ipeer.support@ubc.ca</a>.</p>
