...
<form id="searchForm" action="">
  <table width="95%" border="0" cellspacing="0" cellpadding="2">
    <tr>
      ...
      <td width="80%" align="right">Show Only My Rubric Evaluation Tool(s)? <input type="checkbox" name="show_my_tool" checked />
    ...
    <?php if (!empty($access['MIX_EVAL_RECORD'])) {   ?>
      <tr>
        ...
        <td colspan="4" align="right"><?php echo $html->image('icons/add.gif', array('alt'=>'Add Rubric', 'align'=>'middle')); ?>&nbsp;<?php echo $html->linkTo('Add Rubric', '/rubrics/add'); ?></td>
      </tr>
    <?php }?>
    </table>
</form>
