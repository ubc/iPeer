...
<tr>
    <td>
    <?php if ($event['Event']['is_result_released'] && User::hasPermission('functions/viewstudentresults')):?>
        <?php $id = '/'.$event['Event']['event_template_type_id'] == 3 ? User::get('id') : $event['Group']['id']?>
