...
<table width="100%" border="0" cellspacing="2" cellpadding="4">
  <tr>
    ...
    <td width="96%" class="tablecell"><A HREF="<?php echo $this->webroot.$this->themeWeb;?>evaluations/index/"><?php echo $html->image('layout/yellow_arrow.gif',array('align'=>'middle', 'border'=>'0', 'alt'=>'yellow_arrow'))?> &nbsp;List Evaluation Results
      </a></td>  </tr>
  <tr>
