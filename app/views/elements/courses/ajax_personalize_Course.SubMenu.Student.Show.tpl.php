...
<table width="100%" border="0" cellspacing="2" cellpadding="4">
  <tr>
    ...
    <td width="96%" class="tablecell">
        <A HREF="<?php echo $this->webroot.$this->themeWeb;?>users/add/S">
  ...
  <tr>
    ...
    <td class="tablecell"><A HREF="<?php echo $this->webroot.$this->themeWeb;?>users/goToClassList/<?php echo $this->controller->rdAuth->courseId;?>">
        <?php echo $html->image('layout/yellow_arrow.gif',
