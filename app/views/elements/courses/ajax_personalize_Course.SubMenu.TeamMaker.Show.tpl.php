...
<table width="100%" border="0" cellspacing="2" cellpadding="4">
  <tr>
    ...
    <td width="96%" class="tablecell"><?php echo $html->image('layout/yellow_arrow.gif',array('align'=>'middle', 'border'=>'0', 'alt'=>'yellow_arrow'))?> &nbsp;<a href="<?php echo $this->webroot.$this->themeWeb;?>surveys/goToClassList/<?php echo $this->controller->rdAuth->courseId; ?>">Edit Survey </a></td>
  </tr>
  <tr>
