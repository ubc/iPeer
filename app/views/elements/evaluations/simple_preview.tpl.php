...
<table width="95%" border="0" align="center" cellpadding="4" cellspacing="2">
  ...
  <tr class="tablecell2">
    ...
    <td width="25%"><?php echo $rdAuth->fullname ?></td>
  ...
  <tr class="tablecell2">
    ...
    <td>Due Date:</td>
    <td><?php echo $this->controller->Output->formatDate(date("Y-m-d H:i:s", strtotime('0000-00-00'))) ?></td>
  </tr>
  <tr class="tablecell2">
    <td>Description:&nbsp;</td>
...
<table width="95%" border="0" align="center" cellpadding="4" cellspacing="2">
  ...
  <tr class="tablecell2">
    <td colspan="4" align="center"><?php
      if (!isset($preview)) {
        echo $html->submit('Submit Evaluation', array("disabled"=>'true') );
      }
      ?></td>
    </tr>
</table>
