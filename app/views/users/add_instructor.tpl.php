...
<table width="95%" border="0" align="center" cellpadding="4" cellspacing="2">
  <tr class="tableheader">
    <td colspan="3" align="center">
        <?php echo empty($params['data']['Group']['id'])?'Add':'Edit' ?> Instructor
    </td>
  </tr>
  <tr class="tablecell2">
    <td width="186" id="newuser_label">Username:*</td>
    <td width="361">
      <input type="text" name="newuser" id="newuser" class="validate required TEXT_FORMAT newuser_msg Invalid_Username_Format." value="<?php echo empty($params['data']['User']['username'])? '' : $params['data']['User']['username'] ?>" size="50">
      <?php echo $ajax->observeField('newuser', array('update'=>'usernameErr', 'url'=>"/users/checkDuplicateName", 'frequency'=>1, 'loading'=>"Element.show('loading');", 'complete'=>"Element.hide('loading');stripe();")) ?>
