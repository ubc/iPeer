<?php
/**
 * Duplicated from Cake, modifed to remove confirmation from command line in
 * order to call from continoues integration system
 * Usage: to create ACL database.
 *
 ...
 */
class SchemaCiShell extends Shell {
