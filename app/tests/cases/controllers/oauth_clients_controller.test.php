...
Mock::generatePartial('OauthclientsController',
    'MockOAuthclientsController',
    array('isAuthorized', 'render', 'redirect', '_stop', 'header'));

class OauthClientsControllerTestCase extends ExtendedAuthTestCase {
    ...
    function startCase() {
        echo "Start OAuthClient controller test.\n";
    ...
    function startTest($method) {
        echo $method.TEST_LB;
        $this->controller = new MockOauthclientsController();
    }
