<table width="100%"  border="0" cellpadding="8" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <table width="95%" border="0" align="center" cellpadding="4" cellspacing="2">
    ...
    foreach($data['Instructor'] as $i):?>
  	  ...
  	  <tr>
  		  <td width="15"><a href="mailto:<?php echo $i['email']?>"><?php echo $html->image('icons/email_icon.gif',array('border'=>'0','alt'=>'Email'))?></a></td>
        <td><?php echo $this->element('users/user_info', array('data' => $i))?></td></tr>
    <?php endforeach;?>
	  </table>
	  <?php if (!empty($maillToAll)): ?>
	   <a href="mailto:<?php echo $maillToAll?>"><?php echo $html->image('icons/email.gif',array('border'=>'0','alt'=>'Emaill To All'))?>Email To All Instructors</a>
	  <?php endif;?> 
	  </td>
    </tr>
    <tr class="tablecell">
