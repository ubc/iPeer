...
<table width="100%"  border="0" cellpadding="8" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
    <td>
       ...
       <tr class="tablecell">
       <td width="50"><b><font size="2">Q: <?php echo $count++?></font></b></td>
			  <?php if ($is_editable):?>
						<td width="50"><?php echo $this->Html->link($html->image('icons/edit.gif',array('border'=>'0','alt'=>'Edit', 'valign' => 'middle')).' Edit',
                                                       'editQuestion/'.$question['id'].'/'.$survey_id,
                                                       array('escape' => false))?>
						<td width="60"><?php echo $this->Html->link($html->image('icons/delete.gif',array('border'=>'0','alt'=>'Delete', 'valign' => 'middle')).' Delete',
                                                       'removeQuestion/'.$survey_id.'/'.$question['id'],
                                                       array('escape' => false),
                                                       'Are you sure to delete question &ldquo;'.$question['prompt'].'&rdquo;?')?>
				<td align="right" valign="top">
				<table width="100" align="right" border="0" cellspacing="2" cellpadding="2">
				  <tr>
          <td width="5"><?php echo $this->Html->link($html->image('icons/top.gif',array('border'=>'0','alt'=>'Top')),
                                                     'moveQuestion/'.$survey_id.'/'.$question['id'].'/TOP',
                                                     array('escape' => false))?>
          <td width="5"><?php echo $this->Html->link($html->image('icons/up.gif',array('border'=>'0','alt'=>'Up')),
                                                     'moveQuestion/'.$survey_id.'/'.$question['id'].'/UP',
                                                     array('escape' => false))?>
          <td width="5"><?php echo $this->Html->link($html->image('icons/down.gif',array('border'=>'0','alt'=>'Down')),
                                                     'moveQuestion/'.$survey_id.'/'.$question['id'].'/DOWN',
                                                     array('escape' => false))?>
          <td width="5"><?php echo $this->Html->link($html->image('icons/bottom.gif',array('border'=>'0','alt'=>'Bottom')),
        ...
        <?php endif;?>
          ...
          <tr class="tablecell2">
            <td>
            <div align="center"><?php if ($is_editable) echo $this->Html->link('Add Questions', 'addQuestion/'.$survey_id, array('class' => 'button'))?>
            <?php echo $this->Html->link('Finish', 'index')?></div>
            </td>
          </tr>
      </table>
