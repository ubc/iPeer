...
<td>
  ...
  <table width="95%" align="center" cellpadding="4" cellspacing="2">
    <tr class="tableheader">
      <td colspan="3"><div align="center"><b><?php echo empty($data['User']['id'])?'Add':'Edit' ?> Profile  </b></div></td>
	  </tr>
    <tr class="tablecell2">
...
<?php //} ?>
    ...
    <!-- Email  -->
    <tr class="tablecell2">
      <?php echo $this->Form->input('email', array('size'=>'50', 'class'=>'validate none EMAIL_FORMAT email_msg Invalid_Email_Format.', 'after' => '')) ?>
