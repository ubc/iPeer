<?php
/* SVN FILE: $Id: surveygroups_controller.php 600 2011-06-23 17:49:48Z tonychiu $ */
...
class SurveyGroupsController extends AppController
{
  ...
  var $components = array('Output','sysContainer', 'globalConstant', 'userPersonalize', 'framework','XmlHandler','AjaxList');
