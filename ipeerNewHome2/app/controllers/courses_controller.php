<?php
/* SVN FILE: $Id: courses_controller.php 633 2011-07-06 18:12:54Z tonychiu $ */
/**
...
class CoursesController extends AppController
{
	...
	var $components = array('ExportBaseNew', 'AjaxList', 'ExportHelper', 'ExportBase', 'ExportCsv');
  ...
  function export() {
  	...
  	$mixed = $this->ExportBaseNew->buildMixEvalScoreTableByEvent($params, 44);
	$simple= $this->ExportBaseNew->buildSimpleEvaluationScoreTableByEvent($params, 45);
	$rubrics = $this->ExportBaseNew->buildRubricsEvalTableByEventId($params, 46);
  	$fileName = 'testing';
