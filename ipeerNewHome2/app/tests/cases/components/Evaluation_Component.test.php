...
class EvaluationTestCase extends CakeTestCase {
  ...
  function testFormatGradeReleaseStatus() { 
   ...
   function testchangeSimpleEvaluationCommentRelease {
   	  $input = $this->setUpChangeSimpleEvaluationGradeReleaseTestData();
   	  $evaluator = array('0' => 3, '1' => 4);
   	  $groupEventId = 1;
   	  $groupId = 1;
   	  $eventId = 1;
   	  $this->EvaluationComponentTest->changeSimpleEvaluationGradeRelease($eventId, $groupId, 
   	  														$groupEventId, $evaluator, $input);
	  
   	  														
   }
   
   function setUpChangeSimpleEvaluationGradeReleaseTestData() {
	  $tmp = array(
    	'controller' => 'evaluations',
    	'action' => 'markCommentRelease',
    	'named' => array(),
		'pass' => array(),
    	'plugin' => null, 
    	'form' => array
    	...
    	'url' => array
        	(
            'url' => 'evaluations/markCommentRelease'
        	)
		);
	return $tmp;
   }
