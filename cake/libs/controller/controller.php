<?php
/* SVN FILE: $Id: controller.php,v 1.7 2006/06/20 18:46:31 zoeshum Exp $ */
/**
 ...
 */
	var $base = null;
/**
 * Layout file to use (see /app/views/layouts/default.tpl.php)
 *
 * @var string
 * @access public
 */
 ...
 * Uses flash.tpl.php as a layout for the messages
 *
 ...
 */
	function flash($message, $url, $pause = 1) {
		...
		if (file_exists(VIEWS . 'layouts' . DS . 'flash.tpl.php')) {
			$flash = VIEWS . 'layouts' . DS . 'flash.tpl.php';
		} elseif ($flash = fileExistsInPath(LIBS . 'view' . DS . 'templates' . DS . "layouts" . DS . 'flash.tpl.php')) {
		}
