<?php
/* SVN FILE: $Id: scaffold.php,v 1.3 2006/06/20 18:46:32 zoeshum Exp $ */
 ...
 */
	 function __scaffoldShow($params) {
		  if ($this->controllerClass->_beforeScaffold('show')) {
				...
				if (file_exists(APP . 'views' . DS . $this->viewPath . DS . 'scaffold.show.tpl.php')) {
					 return $this->controllerClass->render($this->actionView, '',
																			APP . 'views' . DS . $this->viewPath . DS . 'scaffold.show.tpl.php');
				} elseif(file_exists(APP . 'views' . DS . 'scaffold' . DS . 'scaffold.show.tpl.php')) {
					 return $this->controllerClass->render($this->actionView, '',
																			APP . 'views' . DS . 'scaffold' . DS . 'scaffold.show.tpl.php');
				} else {
					 return $this->controllerClass->render($this->actionView, '', LIBS . 'view' . DS . 'templates'
																			. DS . 'scaffolds' . DS . 'show.tpl.php');
				}
 ...
 */
	 function __scaffoldIndex($params) {
		  if ($this->controllerClass->_beforeScaffold('index')) {
				...
				if (file_exists(APP . 'views' . DS . $this->viewPath . DS . 'scaffold.list.tpl.php')) {
					 return $this->controllerClass->render($this->actionView, '',
																			APP . 'views' . DS . $this->viewPath . DS . 'scaffold.list.tpl.php');
				} elseif(file_exists(APP . 'views' . DS . 'scaffold' . DS . 'scaffold.list.tpl.php')) {
					 return $this->controllerClass->render($this->actionView, '',
																			APP . 'views' . DS . 'scaffold' . DS . 'scaffold.list.tpl.php');
				} else {
					 return $this->controllerClass->render($this->actionView, '', LIBS . 'view' . DS . 'templates'
																			. DS . 'scaffolds' . DS . 'list.tpl.php');
				}
 ...
 */
	 function __scaffoldError() {
		  if (file_exists(APP . 'views' . DS . $this->viewPath . DS . 'scaffolds' . DS
									. 'scaffold.error.tpl.php')) {
				return $this->controllerClass->render($this->actionView, '', APP . 'views' . DS . $this->viewPath
																	  . DS . 'scaffolds' . DS . 'scaffold.error.tpl.php');
		  } elseif(file_exists(APP . 'views' . DS . 'scaffold' . DS . 'scaffold.error.tpl.php')) {
				...
				return $this->controllerClass->render($this->actionView, '', LIBS . 'view' . DS . 'templates' . DS
																	  . 'errors' . DS . 'scaffold_error.tpl.php');
		  }
	 }
