<?php
/* SVN FILE: $Id: model_php4.php,v 1.4 2006/08/11 17:22:17 rrsantos Exp $ */
 ...
 * @lastmodified	$Date: 2006/08/11 17:22:17 $
 ...
 * @return array Array of records
 */
	function findAll($conditions = null, $fields = null, $order = null, $limit = null, $page = 1, $recursive = null, $join = array()) {
 ...
 * @see Model::findAll
 */
	function findCount($conditions = null, $recursive = 0, $join = array()) {
		list($data) = $this->findAll($conditions, 'COUNT(*) AS count', null, null, 1, $recursive, $join);
