<?php
/* SVN FILE: $Id: dbo_adodb.php,v 1.3 2006/06/20 18:46:37 zoeshum Exp $ */
 ...
 * @lastmodified	$Date: 2006/06/20 18:46:37 $
 ...
 */
	 function connect() {
		  ...
		  $adodb          =&$this->_adodb;
		  $this->connected=$adodb->$connect($config['host'], $config['login'], $config['password'],
														$config['database']);
